export default function AboutMe() {
  return (
    <div
      id="about-me"
      className="bg-light flex flex-col gap-8 items-center justify-center font-merriweather text-xl font-light px-8 py-16 md:text-3xl md:py-32 sm:text-3xl md:px-20 h-screen lg:text-4xl"
    >
      <h2>
